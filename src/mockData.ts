...
University of Technology`,
    ...
    aiAnalysis: {
      ...
      eventInformation: {
        title: 'Thesis Defense: Oral Committee Presentation',
        summary: 'Oral Committee Defense for MSc/PhD Computer Science research thesis',
        description: 'Committee Defense with Prof. Marcus Henderson in Turing Hall 402. Agenda: 45-min slide presentation followed by committee examination and Q&A.',
        startTime: '2026-09-22T14:00:00Z',
        endTime: '2026-09-22T15:30:00Z',
        location: 'Turing Hall 402, Dept of Computer Science',
        attendees: ['m.henderson@oxford-cs.ac.uk'],
      },
    },
    securityAnalysis: {
      classification: 'SAFE',
...
Sarah Lin | VP of Engineering`,
    ...
    aiAnalysis: {
      ...
      eventInformation: {
        title: 'Q3 Architecture Review & Migration Deep Dive',
        summary: 'Cloud infrastructure review with VP of Engineering Sarah Lin',
        description: 'Sync covering Spanner vs PostgreSQL read-replicas benchmarks and database sharding roadmap. Speaking slot: 25 mins.',
        startTime: '2026-09-17T11:00:00Z',
        endTime: '2026-09-17T12:30:00Z',
        location: 'Google Meet: https://meet.apextech.internal/cloud-q3-sync',
        attendees: ['sarah.lin@apextech.com', 'david.chen@apextech.com'],
      },
    },
    securityAnalysis: {
      classification: 'SAFE',
...
Principal Technical Recruiter | Stripe`,
    ...
    aiAnalysis: {
      ...
      eventInformation: {
        title: 'Interview: Stripe Staff Security Engineer Intro Call',
        summary: '30-minute introductory conversation with Principal Recruiter Elena Rostova',
        description: 'Discussion on distributed auth architecture, resilient email pipelines, and Core Security & Infrastructure engineering at Stripe.',
        startTime: '2026-09-15T15:00:00Z',
        endTime: '2026-09-15T15:30:00Z',
        location: 'Google Meet',
        attendees: ['elena.rostova@stripe-talent.com'],
      },
    },
    securityAnalysis: {
      classification: 'SAFE',
